...
const WithdrawMoneyCard = ({ value, handleButtonClicked, account }: any) => {
  ...
  return (
    ...
    >
      <p>
        Click on get contract data button to check whether you can withdraw or
        not.
      </p>
      ...
      <Button
        ...
        colorScheme='teal'
        mt={6}
        disabled={blockchainData?.isWithdrawed ?? true}
